...
int main()
{
        ...
        while (true)
        {
                ...
                if (isAdmin)
                        std::cout << "ServerS finished sending the inventory status to thee Main Server using UDP on port 41367.\n";
                else
                        std::cout << "ServerS finished sending the availability status of code " << code_str << " using UDP on port 41367.\n";
        }
        return 0;
}
